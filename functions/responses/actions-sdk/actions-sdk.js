...
exports.getInitialResponse = (simpleResponseText) => {
    return {
        "expectUserResponse": true,
        "expectedInputs": [
            {
...
exports.getConfirmationResponse = () => {
    return {
        "expectUserResponse": true,
        "expectedInputs": [
            {
...
exports.getDeliveryAddressResponse = () => {
    return {
        "expectUserResponse": true,
        "conversationToken": "{\"data\":{\"firstNum\":23}}",
        "expectedInputs": [
...
exports.getLinkOutSuggestionResponse = () => {
    return {
        "expectUserResponse": true,
        "conversationToken": "{\"data\":{\"firstNum\":23}}",
        "expectedInputs": [
...
exports.getTransactionRequirementsResponse = () => {
    return {
        "expectUserResponse": true,
        "conversationToken": "{\"data\":{\"firstNum\":23}}",
        "expectedInputs": [
...
exports.getOrderUpdateResponse = () => {
    return {
        "expectUserResponse": true,
        "conversationToken": "{\"data\":{\"firstNum\":23}}",
        "expectedInputs": [
